  ...
  return (
    <div className="container mx-auto px-2 lg:px-0">
      <form
        ...
        className="bg-white p-6 lg:p-10  border-2 rounded-2xl w-full lg:w-2/5 mx-auto mt-16"
      >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div>
            <Link className="underline text-red-500">Forgot Password?</Link>
          </div>
        </div>
        ...
        <div className="text-center">
          <button
            type="submit"
            className="bg-pink-500 focus:outline-none font-medium rounded-lg text-sm w-full block py-2.5"
          >
            Login
          </button>
          <div className="mt-4">
            <p>
              ...
              <Link to="/register" className="underline ml-2 text-pink-500">
                Create an account
              </Link>
            </p>
          </div>
